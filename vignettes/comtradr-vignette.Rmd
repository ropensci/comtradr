...
Search trade related to specific commodities (say, tomatoes).
We can query the commodity database to see all of the different commodity descriptions available for tomatoes.
```{r}
