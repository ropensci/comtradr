...
#>  - attr(*, "time_stamp")= POSIXct, format: "2017-10-24 00:06:33"
#>  - attr(*, "req_duration")= num 1.05
```
...
#>  - attr(*, "time_stamp")= POSIXct, format: "2017-10-24 00:06:36"
#>  - attr(*, "req_duration")= num 3.56
```
