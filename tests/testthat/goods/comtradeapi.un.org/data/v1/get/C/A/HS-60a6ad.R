structure(list(method = "GET", url = "https://comtradeapi.un.org/data/v1/get/C/A/HS?cmdCode=TOTAL&flowCode=M%2CX%2CRM%2CRX&partnerCode=32%2C280%2C276&reporterCode=156&period=2010&motCode=0&partner2Code=0&customsCode=C00&includeDesc=TRUE", # nolint start
    status_code = 401L, headers = structure(list(`Content-Length` = "143",
        ...
        Date = "Fri, 01 Sep 2023 17:43:36 GMT"), class = "httr2_headers"),
